    ...
    <div className="app-shell">
      ...
      {view === 'setup' ? <Setup config={config} step={step} setStep={setStep} updateConfig={updateConfig} beginSimulation={beginSimulation} /> : (
        <main className="workspace">
          ...
          {view === 'simulation' ? <Simulation snapshot={snapshot} selectedMetric={selectedMetric} selectedLocation={selectedLocation} setSelectedLocation={setSelectedLocation} activeLayer={activeLayer} setActiveLayer={setActiveLayer} speed={speed} setSpeed={updateSpeed} toggleSimulation={toggleSimulation} resetSimulation={resetSimulation} setView={setView} aiStatus={aiStatus} /> : <Report snapshot={snapshot} bestLocation={bestLocation} brand={config.brand_name} setView={setView} aiStatus={aiStatus} />}
        </main>
      )}
    </div>
  )
